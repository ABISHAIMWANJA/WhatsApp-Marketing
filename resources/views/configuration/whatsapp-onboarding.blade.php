...
<h1>
    ...
    <form class="lw-ajax-form lw-form" method="post"
                ...
                <fieldset>
                    ...
                    <div x-show="openEmbeddedHelp">
                        <div class="row">
                            ...
                            <a class="btn btn-info" href="https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/overview"  target="_blank">{{  __tr('More Information') }}</a>
                            <a class="btn btn-info" href="https://developers.facebook.com/documentation/business-messaging/whatsapp/solution-providers/get-started-for-tech-providers" class="float-right" target="_blank">{{  __tr('Get started for Tech Provider') }}</a>
                        </div>
                            </div>
                        </div>
                    <dl>
                        ...
                        <dd>{{  __tr('Follow the instructions on the given link to become tech provider so, your customers can use Embedded signup to get their account connected.') }}
                            <div>
                                <a target="_blank" href="https://developers.facebook.com/documentation/business-messaging/whatsapp/solution-providers/get-started-for-tech-providers">{{  __tr('How to become Tech Provider?') }}</a>
                            </div>
                            <div>
            ...
            <div x-show="!embeddedSignUpDataExists" class="col-sm-12 col-md-6 col-lg-4">
                <a target="_blank" href="https://developers.facebook.com/documentation/business-messaging/whatsapp/solution-providers/get-started-for-tech-providers#before-you-start" class="float-right btn btn-info btn-sm">{{  __tr('Help') }} <i class="fas fa-external-link-alt"></i></a>
                ...
                <a target="_blank" href="https://developers.facebook.com/documentation/business-messaging/whatsapp/embedded-signup/implementation#step-2-create-a-facebook-login-for-business-configuration" class="float-right btn btn-info btn-sm mt-3">{{  __tr('Help') }} <i class="fas fa-external-link-alt"></i></a>
